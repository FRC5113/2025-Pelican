import rev
import wpilib
from rev import SparkMax, SparkBaseConfig, SparkRelativeEncoder, SparkMaxAlternateEncoder,SparkMaxConfig,AlternateEncoderConfig
...
class Claw:
    ...
    #hinge_encoder: SparkMaxAlternateEncoder
    ...
    def setup(self):
        #self.hinge_motor_config = SparkMaxConfig()
        #self.hinge_motor_config.alternateEncoder.Type(AlternateEncoderConfig.Type.kQuadrature)
        #self.hinge_motor_config.IdleMode(SparkBaseConfig.IdleMode.kBrake)
        self.hinge_motor.configure(
            #self.hinge_motor_config,
    ...
    def on_enable(self):
        self.controller = self.claw_profile.create_turret_controller("claw") #using turret controller for claw until arm is made
